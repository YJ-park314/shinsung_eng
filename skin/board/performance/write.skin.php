...
<article id="performanceWrt" class="no-vis-pd">
    <section id="bo_w">
        <div class="wrap">
            ...
            <?php if ($is_category) { ?>
            <div class="bo_w_select write_div bo-left">
            ...
            <div class="bo_w_tit write_div bo-right">
            ...
            <div class="btn_confirm write_div write-bottom">
                <div class="left">
                    <p>공사날짜선택(필수)</p>
                    <!-- 여분필드 : 공사 날짜 -->
                    <input type="month" name="wr_1" value="<?php echo $wr_1 ?>" title="공사날짜" class="input-month" required>
                </div>
                <div class="right">
                    <a href="<?php echo get_pretty_url($bo_table); ?>" class="btn con bd-blue">취소</a>
                    <button type="submit" id="btn_submit" accesskey="s" class="btn con blue">작성완료</button>
                </div>
            </div>
            </form>
...
<style>
    #performanceWrt #smart_editor2{border: 1px solid red;}
</style>